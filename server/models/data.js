const data = {
    "data": [
        ...
        },
        {
            ...
            "subject": "COMPSCI",
            "credits": 1,
            "description": "The colloquium will focus on advanced topics and recent research topics related to computer vision. Students will participate in group discussions and carry out a group or individual project which will be an extension to the project work in COMPSCI 370.",
            "prerequisites": [],
            "number": "H370"
        },
        {
            ...
            "subject": "COMPSCI",
            "credits": 1,
            "description": "Students will meet with instructor in small group setting with the class instructor on a weekly basis to discuss related topics of interest, including but not limited to: Internet privacy, network neutrality, network source code implementation.",
            "prerequisites": [],
            "number": "H453"
        },
        {
        ...
        },
        {
            ...
            "subject": "COMPSCI",
            "credits": 3,
            "description": "Intelligent visual computing is an emerging new field that seeks to combine modern trends in machine learning, computer graphics, computer vision to intelligently process, analyze and synthesize 2D/3D visual data. The course will start by covering 2D image and 3D shape representations, classification and regression techniques, and the fundamentals of deep learning. The course will then provide an in-depth background on analysis and synthesis of images and shapes with deep learning, in particular convolutional neural networks, recurrent neural networks, memory networks, auto-encoders, adversarial networks, reinforcement learning methods, and probabilistic graphical models. Students will complete 5 programming assignments in Matlab/Octave and work on a course project related to visual computing with machine learning.  Course was previously COMPSCI 690IV.",
            "prerequisites": [],
            "number": "674"
        },
        {
        ...
        },
        {
            ...
            "subject": "COMPSCI",
            "credits": 1,
            "description": "Weekly seminar requiring students to read an NLP paper and discuss and review it from a variety of perspectives. Some weeks will feature invited speakers instead of paper reviews.",
            "prerequisites": [],
            "number": "692L"
        },
        {
